...
rf = nrefocus.iface.RefocusCupy(cell1, wavelength=pixel_size,
                                medium_index=1,
                                pixel_size=pixel_size)
cell2_gpu = rf.propagate(distance=15 * pixel_size)
cell3_gpu = rf.propagate(distance=-15 * pixel_size)
...
plt.suptitle("Refocused cell on GPU with Cupy")
plt.tight_layout()
plt.show()
